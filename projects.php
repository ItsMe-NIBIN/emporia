...
<div id="pageWrapper" class="projectsPage">

    <!-- Inner Banner Section  -->
    <section id="InnerBanner">
        <div class="BannerImg">
            <img src="assets/images/Projects-banner.jpg" alt="Team Banner" width="1920" height="635" class="lazy"
                loading="lazy" data-src="assets/images/Projects-banner.jpg">
        </div>
        <div class="bannerCnt">
            <div class="container">
                <div class="bannertitle">PROJECTS</div>
            </div>
        </div>
    </section>
    <!-- Inner Banner Section  -->
