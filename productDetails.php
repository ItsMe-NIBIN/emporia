...
<div id="pageWrapper" class="productsPage">
    ...
    <section id="InnerBanner">
        <div class="BannerImg">
            <img src="assets/images/productList-banner.jpg" alt="Team Banner" width="1920" height="635" class="lazy"
                loading="lazy" data-src="assets/images/productList-banner.jpg">
        </div>
        <div class="bannerCnt">
            <div class="container">
                <div class="bannertitle">GUESTROOMS</div>
            </div>
        </div>
    </section>
    <!-- Inner Banner Section  -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="assets/images/proDet1.jpg" data-fancybox="group" class="proDetailBox heightHigh"
                            ...
                            <div class="cntBx">
                                <p>Bring a bit of the five – star hotel touch to your own home and bedroom. Soft, firm
                                    and smooth to touch, even the most mundane bed is easily transformed into luxury
                                    with our quality bedding linen. Discover our broad selection of bedding linen made
                                    from the finest quality of Egyptian cotton.</p>
                            </div>
                        </a>
                    </div>
