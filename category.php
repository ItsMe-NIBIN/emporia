...
<div id="pageWrapper" class="productsPage">
    ...
    <section id="InnerBanner">
        <div class="BannerImg">
            <img src="assets/images/ffande-banner.jpg" alt="Team Banner" width="1920" height="635" class="lazy"
                loading="lazy" data-src="assets/images/ffande-banner.jpg">
        </div>
        <div class="bannerCnt">
            <div class="container">
                <div class="bannertitle">FF & E</div>
            </div>
        </div>
    </section>
    <!-- Inner Banner Section  -->
    ...
    <section id="productsListSec" class="prosecOne">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="categoryListing.php" class="productBox">
                            ...
                            <div class="Title">Outdoor Furniture</div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a href="categoryListing.php" class="productBox">
                            ...
                            <div class="Title">Lobby furniture</div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a href="categoryListing.php" class="productBox">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="categoryListing.php" class="productBox">
                            ...
                            <div class="Title">center tables</div>
                        </a>
                    </div>
                </div>
            </div>
