...
<div id="pageWrapper" class="projectDetailsPage">

    <!-- Inner Banner Section  -->
    <section id="InnerBanner">
        <div class="BannerImg">
            <img src="assets/images/ProjectDetails-banner.jpg" alt="Team Banner" width="1920" height="635" class="lazy"
                loading="lazy" data-src="assets/images/ProjectDetails-banner.jpg">
        </div>
        <div class="bannerCnt">
            <div class="container">
        ...
        <div class="container">
            <div class="contentSec" data-aos="fade-up">
                ...
                <p>Qui-vere falsone, quaerere mittimus-dicitur oculis se privasse; Hoc est dicere: Non reprehenderem
                    ...
                    quadam distinguitur. Mihi vero, inquit, placet agi subtilius et</p>
            </div>
            <div class="detailSec">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="javascript:void(0);" class="paginateBx prev" data-aos="fade-up">
                            ...
                            <div class="cntSec">
                                <div class="dir">Previous Project</div>
                                <div class="name">Emirates Palace</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="javascript:void(0);" class="paginateBx next" data-aos="fade-up">
                            ...
                            <div class="cntSec">
                                <div class="dir">Next Project</div>
                                <div class="name">Le Meridien</div>
                            </div>
                        </a>
                    </div>
                </div>
