...
<div id="pageWrapper" class="retailPage">

    <!-- Inner Banner Section  -->
    <section id="InnerBanner">
        <div class="BannerImg">
            <img src="assets/images/Retail-banner.jpg" alt="Team Banner" width="1920" height="635" class="lazy"
                loading="lazy" data-src="assets/images/Retail-banner.jpg">
        </div>
        <div class="bannerCnt">
            <div class="container">
                <div class="bannertitle">RETAIL</div>
            </div>
        </div>
    </section>
    <!-- Inner Banner Section  -->
    ...
    <section id="cntSec">
        <div class="container">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quo modo autem optimum, si bonum praeterea
                ...
                Aristophanem putamus aetatem in litteris duxisse? Quod mihi quidem visus est, cum sciret, velle tamen
                confitentem audire Torquatum.</p>
        </div>
    </section>
    <!-- Contents Section  -->
    ...
    <!-- Retail Section  -->
    <section id="retailSec">
        <div class="container">
            <div class="retailbx">
                <div class="MainHead">
                    <div class="Head">DISTRIBUTION Foods and refreshments</div>
                </div>
